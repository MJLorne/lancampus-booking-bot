...
export function ensureTasksInChecklist(cleaning) {
  const template = {
    ...
    kueche: [["spuelmaschine", "Spülmaschine leeren"], ["aufraeumen", "Aufräumen"], ["geschirr", "Geschirr auf Sauberkeit prüfen"], ["putzen", "Küche putzen"], ["kuehlschrank", "Kühlschrank auswischen"], ["wasserkocher", "Wasserkocher reinigen"], ["eierkocher", "Eierkocher reinigen"], ["kaffee", "Kaffeemaschine reinigen"], ["muelleimer", "Mülleimer leeren"], ["staubsaugen", "Staubsaugen"], ["wischen", "Wischen"]],
    schlafzimmer: [["betten", "Betten abziehen"], ["bettwaesche", "Bettwäsche waschen"], ["schraenke", "Schränke kontrollieren"], ["bettkaesten", "Bettkästen kontrollieren"], ["staubsaugen", "Staubsaugen"], ["bilder", "Bilder gerade rücken"], ["wischen", "Wischen"]],
